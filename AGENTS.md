...
Ultralytics iSky is an AGPL-3.0 licensed iOS app that applies real-time neural style transfer to the live iPhone and iPad camera feed, rendering the world in five famous painting styles. It is a pure Swift, UIKit and storyboard app built with Xcode (`iSky.xcodeproj`) that runs Core ML style-transfer models through Vision.
